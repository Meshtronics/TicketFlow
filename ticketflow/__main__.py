...
import os, sys, subprocess, textwrap, argparse
...
def main() -> None:
    ...
    ui = sub.add_parser("ui", help="Launch Streamlit dashboard")
    ...
    new.add_argument("--github", action="store_true",
                     help="Force create GitHub Issue")
